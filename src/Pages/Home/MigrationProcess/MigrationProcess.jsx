...
const MigrationProcess = () => (
  <section id="migration-process" className="process-section">
    ...
    <div className="steps">  
      <div className="step">
        <div className="step-overlay">
          ...
          <div className="step-title">Signup</div>
          <div className="step-description">
          Join us to optimize your Tally setup and enhance your data management.
          </div>
        </div>
      </div>
      ...
      <div className="step">
        <div className="step-overlay">
          ...
          <div className="step-title">Connect Zoho Books</div>
          <div className="step-description">
         We prepare and verify data for seamless migration to Zoho Books.
          </div>
        </div>
      </div>
      ...
      <div className="step">
        <div className="step-overlay">
          ...
          <div className="step-title">Download Tally Agent</div>
          <div className="step-description">
           We create a tailored migration plan with clear milestones for a smooth transition.
          </div>
        </div>
      </div>
      ...
      <div className="step">
        <div className="step-overlay">
          ...
          <div className="step-title"> Prepare & Plan</div>
          <div className="step-description">
          We prepare the data for migration to Zoho Books efficiently.
          </div>
        </div>
      </div>
      ...
      <div className="step">
        <div className="step-overlay">
          ...
          <div className="step-title">Migrate & Support</div>
          <div className="step-description">
          We migrate your data to Zoho Books and provide training and ongoing support.
          </div>
        </div>
      </div>
    </div>
